...
reveal_type(np.polyfit(AR_f8, AR_i8, 1, full=True))  # E: tuple[ndarray[Any, dtype[{float64}]], ndarray[Any, dtype[{float64}]], ndarray[Any, dtype[{int32}]], ndarray[Any, dtype[{float64}]], ndarray[Any, dtype[{float64}]]]
...
reveal_type(np.polyfit(AR_f8, AR_c16, 1, full=True))  # E: tuple[ndarray[Any, dtype[{complex128}]], ndarray[Any, dtype[{float64}]], ndarray[Any, dtype[{int32}]], ndarray[Any, dtype[{float64}]], ndarray[Any, dtype[{float64}]]]
